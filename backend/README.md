...
- batch Short mendeteksi beberapa wajah yang benar-benar muncul bersamaan; layout pembicara utama + panel konteks grup hanya dialokasikan ke 1 klip pada batch kecil atau maksimal 2 pada batch besar agar variasi tidak menjadi template berulang
...
- semua sidecar mencatat eksperimen stabilitas 5K: minimal tiga dari lima upload seformat dan seseri mencapai 5K, dibandingkan rolling median 10 upload sebanding; Short memakai checkpoint 500/2K/5K/10K, sedangkan long-form 100/500/1K/5K dan memantau impressions, CTR Beranda/Disarankan, retention 30 detik, average view duration, titik drop/spike, end-screen, serta subscriber; status ini bukan jaminan jumlah view
