...
DEFAULT_YOUTUBE_LOGIN_PROFILE_DIR="$CONFIG_HOME/fendy-clipper/youtube-chrome-profile"
LEGACY_YOUTUBE_LOGIN_PROFILE_DIR="${LEGACY_YOUTUBE_LOGIN_PROFILE_DIR:-/tmp/fendy-clipper-youtube-login}"
