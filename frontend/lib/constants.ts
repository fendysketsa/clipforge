...
export const COMPILATION_TARGET_SECONDS = COMPILATION_MIN_SECONDS;
export const DEFAULT_AI_ENABLED = true;
export const DEFAULT_AI_BASE_URL = "http://localhost:11434/v1";
export const DEFAULT_AI_MODEL = "llama3.2-id:latest";
export const DEFAULT_REQUIRED_HASHTAGS = "viralindonesia, trendingindonesia, kontenpilihan";
